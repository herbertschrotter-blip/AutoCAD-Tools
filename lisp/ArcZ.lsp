...
;;; - Error-Handler ohne command (kompatibel mit AutoCAD 2024+)
;;;
;;; Lizenz: MIT
;;; ============================================================================
...
(defun c:ARCZ ( / *error* p1 p2 p3 oldUCS old-cmdecho ucs-changed)
  ...
  (defun *error* (msg)
    ...
    ;; UCS wiederherstellen nur wenn es geändert wurde
    (if ucs-changed
      (progn
        (if oldUCS
